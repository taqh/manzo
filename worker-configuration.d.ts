/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6d24153cc062a786d618c1a630a9a827)
...
interface __BaseEnv_CloudflareBindings {
	...
	EMAIL: SendEmail;
	AI: Ai;
	AI_MODEL: "@cf/moonshotai/kimi-k2.7-code";
	AI_GATEWAY_ID: "default";
	DEFAULT_OUTBOUND_MAILBOX: "agent@example.com";
	MANAGED_MAILBOXES: "agent@example.com";
	TELEGRAM_BOT_TOKEN: string;
	TELEGRAM_WEBHOOK_SECRET: string;
	TELEGRAM_CHAT_ID: string;
	TELEGRAM_BOT_USERNAME: string;
	InboxAgent: DurableObjectNamespace<import("./src/index").InboxAgent>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "AI_GATEWAY_ID" | "DEFAULT_OUTBOUND_MAILBOX" | "MANAGED_MAILBOXES" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_WEBHOOK_SECRET" | "TELEGRAM_CHAT_ID" | "TELEGRAM_BOT_USERNAME">> {}
}
